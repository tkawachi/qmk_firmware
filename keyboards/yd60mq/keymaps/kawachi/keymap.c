...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  // lower
	[_LW] = LAYOUT_all(
        ...
        _______, _______, _______, _______, _______, _______, _______, KC_UNDS, _______, _______, _______, KC_BSLS, _______, _______, _______,
  ...
  // raise
	[_RS] = LAYOUT_all(
        ...
        _______, _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_1,    KC_2,    KC_3,    _______, _______, KC_VOLU, _______,
        _______, AG_SWAP, _______,                   _______, _______, _______,                   _______, _______, _______, KC_VOLD, _______
    ),
